...
- Под каждый пример (свой callback) который обрабатывает каждый элемент массива

Первая функция возвращает строку “New value: ” и результат работы callback:
...
/**
 * 2. Создать функции аналогичные перебирающим методм массивов, которые будут полностью повторять их поведение.
 * Например метод every, findIndex, map, reduce и тд
 * Главное условие не использовать данные методы внутри вашей реализации аналогов.
*/
